import { handleSimpleChatRequest } from "../../server/chat/simple-chat-handler.js";
...
function toRequest(req: NodeRequestLike) {
  return new Request("https://aura.local/api/chat/send", {
...
export default async function handler(
  ...
  const result = await handleSimpleChatRequest(toRequest(request));
